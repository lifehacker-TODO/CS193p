...
//  lesson4
//
//  Created by Leiyou Who on 1/25/15.
...
- (void)viewWillAppear:(BOOL)animated{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(perferredFontsChanged:) name:UIContentSizeCategoryDidChangeNotification object:nil];
